...
db.passengers.insert({
	_id: "5ed2aa4b9124c100284808e4",
	id: "45872359V",
	name: "Paco Gonzalez",
	url_image:"https://www.cs.upc.edu/~bcasas/img/f5-192x256c.jpg",
	type_user: 1,
...
db.boarding_passes.insert({
	id_hash: "majs921hnw1mx999_p",
        seat: "1B",
        id_passenger: "45872359V",
	name_passenger: "Federico Molina",
        flights: "VL0204"
	});

db.boarding_passes.insert({
	id_hash: "majs92m871233x999_p",
        seat: "10D",
        id_passenger: "Y2304117L",
	name_passenger: "Héctor Delgado",
        flights: "QR6213"
	});

db.boarding_passes.insert({
	id_hash: "mkkjs9__7a2sabTp",
        seat: "12C",
        id_passenger: "01833112M",
	name_passenger: "Perico de los Palotes",
        flights: "QR6213"
	});
