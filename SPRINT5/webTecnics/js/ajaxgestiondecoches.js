...
$(document).ready(function(){
    document.getElementById("modif2").addEventListener("click", function(){
        ...
        if(cambia){
            if(nombres.length ==1){
                swal({
                    title: "¿Estás seguro de que quieres modificar el estado de este coche?"+ " "+ nombres[0],
                    icon: "warning",
                    buttons: true,
                  })
                  .then((willDelete) => {
                ...
                swal({
                    title: "¿Estás seguro de que quieres modificar el estado de estos coches?"+ " "+ nombres.join("\n"),
                    icon: "warning",
                    buttons: true,
                  })
                  .then((willDelete) => {
